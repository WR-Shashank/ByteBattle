...
const Editorial = ({ secureUrl, thumbnailUrl, duration }) => {
  ...
  <div className="alert alert-warning shadow-lg max-w-md mx-auto mt-8">
    <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.054 0 1.702-1.14 1.198-2.048L13.198 4.048c-.526-.912-1.87-.912-2.396 0L3.884 16.952C3.38 17.86 4.028 19 5.082 19z" />
    </svg>
    <span>No video solution is present.</span>
  </div>
);
};
