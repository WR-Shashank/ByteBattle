...
const Contestsubmissionhistory = ({ problemId,contestId }) => {
  ...
  useEffect(() => {
    const fetchSubmissions = async () => {
      try {
        setLoading(true);
        const response = await axiosClient.get(`/contest/contestSubmission/${contestId}/${problemId}`);
  ...
  return (
    <div className="container h-120 mx-auto p-4 overflow-scroll">
              ...
              <tbody>
                {submissions.map((sub, index) => (
                  <tr key={sub._id}>
                    ...
                    <td className="font-mono">{sub.testCasesPassed}/{sub. totalTestCases}</td>
          ...
          <div className="modal-box w-11/12 max-w-5xl">
            ...
            <div className="mb-4">
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <span className="badge badge-outline">
                  Passed Test Cases: {selectedSubmission.testCasesPassed}/{selectedSubmission. totalTestCases} 
                </span>
              </div>
...
export default Contestsubmissionhistory;